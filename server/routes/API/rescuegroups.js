...
router.route("/").post(function(req, res) {
    ...
    return axios.post("https://api.rescuegroups.org/http/v2.json", {
        ...
        "search" : {
            ...
            "fields": ["animalID","animalAgeString", "animalGeneralAge", "animalBreed","animalDescription","animalLocationCitystate","animalName","animalPrimaryBreed","animalSpecies","animalThumbnailUrl","animalUrl","animalPictures"]
        }
    }).then(response => {
